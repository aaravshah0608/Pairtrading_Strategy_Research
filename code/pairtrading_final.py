# -*- coding: utf-8 -*-
"""PairTrading_Final.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1mIN5RaBHtjFOjFtzdTDfe7UiIW7RFomn
"""
...
with pd.ExcelWriter(OUT_FILE, engine='xlsxwriter') as writer:
    ...
    ws_readme.set_column('A:A', 50)
    ws_readme.write('A1', 'Project: Pair Trading Strategy', f_bold)
    ws_readme.write('A3', 'Compatibility Note:')
    ws_readme.write('A4', 'This file is optimized for Google Sheets.')
    ws_readme.write('A5', 'If you are using Microsoft Excel and encounter formula errors:')
    ws_readme.write('A6', '1. Excel may automatically insert "@" symbols into formulas.')
    ws_readme.write('A7', '2. If formulas fail, try removing the "@" symbol from the formula bar.')
    ws_readme.write('A8', '3. Ensure your Excel regional settings use the correct list separator (comma or semicolon).')
...
print(f"Excel spreadsheet: {OUT_FILE}")
